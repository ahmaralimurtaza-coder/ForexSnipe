      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () async {
            ...
            else { if (context.mounted) Navigator.pop(context); }
          },
        ),
        actions: [
        ...
        bottom: PreferredSize(
          ...
          child: _isLoading
              ? LinearProgressIndicator(value: _progress, backgroundColor: Colors.transparent, color: AppColors.green, minHeight: 3)
